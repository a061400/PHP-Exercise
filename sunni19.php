...
<form action="sunni20.php" method="get">
...
<hr>
<!-- Event ==> onXxx="處理事件(JS)" -->
<form action="sunni21.php" onsubmit="return chForm();" method="get">  <!-- get會顯示內容到網址列 -->
    <input type="text" name="account"><br>
    <input type="password" name="passwd"><br>
    <input type="submit" value="OK">
</form>
<hr>
<form action="sunni22.php"  method="post">    <!-- post不會顯示內容到網址列 -->
    <input type="text" name="account" /><br>
    <input type="submit" value="OK">
</form>